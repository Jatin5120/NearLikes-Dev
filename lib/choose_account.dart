...
class _ChooseAccountState extends State<ChooseAccount> {
  ...
  Widget build(BuildContext context) {
    int followersCount = widget.ig_details['followers_count'];
    return WillPopScope(
      onWillPop: () async {
                    ...
                    child: Row(
                      children: [
                        Padding(
                          ...
                          child: Image.network(
                              widget.ig_details["profile_picture_url"],
                              width: 55,
                              height: 55),
                        ),
                        const SizedBox(
                            ...
                            Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(
                                    builder: (context) => ChooseInterests(
                                          ...
                                          igDetails: widget.ig_details,
                                          phnum: widget.phnum,
                                          name: widget.name,
                                          igUserId: widget.ig_userId,
                                          location: widget.location,
                                          age: widget.age,
                                        )));
                          } else {

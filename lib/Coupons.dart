          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 35,),
                Center(
                  child: Text("MY COUPONS",style: GoogleFonts.montserrat(
                    fontSize: 16,
                ...
                FutureBuilder(
                    ...
                    builder: (context, AsyncSnapshot snapshot) {
                      ...
                      return _getCustomer.customer.coupons.length==0? Padding(
                          ...
                          child:Text('Post a story to get coupon',style: TextStyle(
                              color: Colors.red,
                              fontSize: 15
                          ),)): GridView.builder(
                          reverse: true,
                          ...
                          itemBuilder: (BuildContext ctx, index) {
                            if(_getCustomer.customer.coupons[index].used)
                            {
                              ...
                              return GestureDetector(
                                  onTap: () async{
                                    await goToDialog(_getCustomer.customer.coupons[index].code,_getCustomer.customer.coupons[index].brand,_getCustomer.customer.coupons[index].id);
                                    print("tapped");
